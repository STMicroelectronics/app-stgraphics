...
class Triangle {
     ...
     */
    void initTriangle(int programHandle, float[] viewMatrix, boolean texture) {
     ...
     */
    void updateTriangle(int width, int height) {
     ...
     */
    void drawTriangle(final FloatBuffer aVerticesBuffer, final FloatBuffer aColorBuffer,
